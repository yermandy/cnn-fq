...
class CNNFQ(nn.Module):
    ...
    def __init__(self):
        ...
        # 0.55188 | 0.41968 | 0.35866 <- mean
        # 0.12564 | 0.11003 | 0.11498 < std

        # ? mean 141.55 | 107.64 | 91.79
        # ?  std 31.10  | 27.36  | 28.82
        self.meta = {'mean': [0.555, 0.422, 0.359], 
                     'std': [1, 1, 1],
                     'imageSize': [224, 224, 3]}
        ...
        self.feat_extract = nn.Conv2d(2048, 1, kernel_size=[1, 1], stride=(1, 1), bias=False)
    ...
    def forward(self, data):
        ...
        feature = self.feat_extract(pool5_7x7_s1)
